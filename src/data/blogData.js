...
export const blogPosts = [
    ...
    translations: {
      es: {
        ...
        content: `
          ...
          <p>¡Es muy fácil y totalmente <strong>GRATIS</strong>! Al finalizar cualquiera de nuestros tours (Grand Tour of Copenhagen, Christianshavn o Pub Crawl), simplemente pídele a tu guía tu imán o pegatina de regalo. Es nuestra forma de darte las gracias por elegirnos y para que te lleves el mejor recuerdo de tu paso por Dinamarca.</p>
      ...
      en: {
        ...
        excerpt: 'Discover our new exclusive magnets and stickers featuring the Free Tour CPH design. A completely free souvenir of your visit to Copenhagen.',
        content: `
          ...
          <p>It's very easy and completely <strong>FREE</strong>! At the end of any of our tours (Grand Tour of Copenhagen, Christianshavn, or Pub Crawl), simply ask your guide for your complimentary magnet or sticker. It's our way of saying thank you for choosing us, so you can take home the best souvenir of your time in Denmark.</p>
      ...
      it: {
        ...
        excerpt: 'Scopri i nostri nuovi magneti e adesivi esclusivi con il design di Free Tour CPH. Un souvenir completamente gratuito della tua visita a Copenaghen.',
        content: `
          ...
          <p>È semplicissimo e totalmente <strong>GRATUITO</strong>! Alla fine di uno qualsiasi dei nostri tour (Grand Tour of Copenhagen, Christianshavn o Pub Crawl), chiedi semplicemente alla tua guida il tuo magnete o adesivo in omaggio. È il nostro modo per ringraziarti di averci scelto e per farti portare a casa il miglior ricordo del tuo viaggio in Danimarca.</p>
    ...
    translations: {
      es: {
        ...
        content: `
          ...
          <h3>1. Únete a un Free Walking Tour</h3>
          <p>La mejor manera de conocer el centro histórico y orientarte es caminando con nosotros. Pagas lo que consideras justo al final del recorrido.</p>
          
          <h3>2. Come en los carritos de Hot Dogs (Pølsevogn)</h3>
          <p>Un clásico danés. Los perritos calientes son deliciosos, tradicionales y muy económicos.</p>
          
          <h3>3. Alquila una bicicleta</h3>
          <p>La ciudad está diseñada para las bicicletas. Te ahorrarás el transporte público y vivirás la ciudad como un verdadero danés.</p>
          
          <h3>4. Disfruta de los parques y jardines</h3>
          <p>El Jardín del Rey (Kongens Have) o el jardín botánico son completamente gratuitos y espectaculares.</p>
          
          <h3>5. Compra comida en supermercados locales</h3>
          <p>Netto o Rema 1000 son excelentes opciones para armar un picnic y comer frente a los canales de Nyhavn sin pagar precios de restaurante.</p>
          
          <h3>6. Bebe agua del grifo</h3>
          <p>El agua de grifo en Dinamarca es de las más puras del mundo. Trae tu botella reutilizable.</p>
          
          <h3>7. Busca los museos con días gratuitos</h3>
          <p>Algunos museos ofrecen entrada libre en días específicos de la semana. ¡Averigua antes de ir!</p>
          
          <h3>8. Sube a la torre de Christiansborg gratis</h3>
          <p>A diferencia de otras torres que cobran entrada, la vista panorámica desde el Parlamento danés es gratuita (¡solo debes pasar seguridad!).</p>
          
          <h3>9. Explora Christiania</h3>
          <p>Pasear por la ciudad libre de Copenhague es una experiencia cultural única y no cuesta ni un céntimo.</p>
          
          <h3>10. Camina por Kastellet y saluda a La Sirenita</h3>
          <p>La famosa fortaleza en forma de estrella y el ícono de la ciudad están en espacios públicos de acceso libre.</p>
        `
      },
      en: {
        title: '10 tips for traveling to Copenhagen on a budget',
        excerpt: 'Discover how to enjoy the coziest city in Northern Europe without breaking the bank.',
        content: `
          <p>Copenhagen is known for being an expensive city, but visiting on a budget isn't impossible. Here are our top 10 local tips:</p>
          
          <h3>1. Join a Free Walking Tour</h3>
          <p>The best way to get to know the historic center and get your bearings is by walking with us. You pay what you think is fair at the end of the tour.</p>
          
          <h3>2. Eat at Hot Dog stands (Pølsevogn)</h3>
          <p>A Danish classic. The hot dogs are delicious, traditional, and very affordable.</p>
          
          <h3>3. Rent a bike</h3>
          <p>The city is designed for bikes. You'll save on public transport and experience the city like a true Dane.</p>
          
          <h3>4. Enjoy the parks and gardens</h3>
          <p>The King's Garden (Kongens Have) or the Botanical Garden are completely free and spectacular.</p>
          
          <h3>5. Buy food at local supermarkets</h3>
          <p>Netto or Rema 1000 are excellent options for putting together a picnic and eating by the Nyhavn canals without paying restaurant prices.</p>
          
          <h3>6. Drink tap water</h3>
          <p>Tap water in Denmark is among the purest in the world. Bring your reusable bottle.</p>
          
          <h3>7. Look for museums with free days</h3>
          <p>Some museums offer free entry on specific days of the week. Do your research before you go!</p>
          
          <h3>8. Climb the Christiansborg tower for free</h3>
          <p>Unlike other towers that charge an entrance fee, the panoramic view from the Danish Parliament is free (you just have to pass security!).</p>
          
          <h3>9. Explore Christiania</h3>
          <p>Strolling through Copenhagen's freetown is a unique cultural experience and doesn't cost a dime.</p>
          
          <h3>10. Walk around Kastellet and greet The Little Mermaid</h3>
          <p>The famous star-shaped fortress and the city's icon are in free-access public spaces.</p>
        `
      }
    }
  },
  {
    ...
    translations: {
      es: {
        title: 'Cómo llegar del aeropuerto de Copenhague al centro',
        excerpt: 'Guía rápida y sencilla para transportarte desde Kastrup al corazón de Copenhague en minutos.',
        content: `
          <p>El aeropuerto de Copenhague (Kastrup) está increíblemente bien conectado con el centro de la ciudad. El viaje toma menos de 15 minutos. Aquí tienes las mejores opciones:</p>
          
          <h3>Metro (La opción más rápida)</h3>
          <p>La línea amarilla (M2) sale directamente desde la Terminal 3. Funciona las 24 horas del día. En tan solo 13 minutos estarás en Nørreport, el núcleo principal de la ciudad.</p>
          
          <h3>Tren (Ideal si vas a la Estación Central)</h3>
      ...
      en: {
        title: 'How to get from Copenhagen Airport to the city center',
        excerpt: 'Quick and easy guide to get from Kastrup to the heart of Copenhagen in minutes.',
        content: `
          <p>Copenhagen Airport (Kastrup) is incredibly well connected to the city center. The journey takes less than 15 minutes. Here are the best options:</p>
          
          <h3>Metro (The fastest option)</h3>
          <p>The yellow line (M2) departs directly from Terminal 3. It runs 24 hours a day. In just 13 minutes you'll be at Nørreport, the main hub of the city.</p>
          
          <h3>Train (Ideal if you're going to Central Station)</h3>
  ...
  },
  {
    ...
    image: '/images/blog/castillo-frederiksborg-dinamarca.png',
    date: '2026-04-15',
    translations: {
      es: {
        title: 'Los 5 castillos que no te puedes perder en Dinamarca',
        excerpt: 'De la historia de Shakespeare a la residencia real, los palacios más impresionantes de Dinamarca.',
        content: `
          <p>Dinamarca es una de las monarquías más antiguas del mundo, lo que significa una sola cosa: ¡Castillos increíbles! Aquí te presentamos los 5 que debes visitar:</p>
          
          <h3>1. Castillo de Rosenborg (Copenhague)</h3>
          <p>Ubicado en el centro de la ciudad, este castillo renacentista guarda las Joyas de la Corona Danesa. Sus jardines (Kongens Have) son el lugar favorito de los locales para hacer picnics.</p>
          
          <h3>2. Palacio de Amalienborg (Copenhague)</h3>
          <p>La residencia de invierno de la familia real. Es un complejo de cuatro palacios idénticos alrededor de una plaza octogonal. ¡No te pierdas el cambio de guardia al mediodía!</p>
          
          <h3>3. Castillo de Kronborg (Helsingør)</h3>
          <p>Mundialmente famoso por ser el escenario de "Hamlet" de Shakespeare. Situado frente a las costas de Suecia, es Patrimonio de la Humanidad por la UNESCO.</p>
          
          <h3>4. Castillo de Frederiksborg (Hillerød)</h3>
          <p>El "Versalles nórdico". Es el castillo renacentista más grande de Escandinavia y alberga el Museo Nacional de Historia. Su ubicación sobre tres islotes es simplemente mágica.</p>
          
          <h3>5. Palacio de Christiansborg (Copenhague)</h3>
          <p>El centro del poder danés. Alberga el Parlamento, la Corte Suprema y las salas de recepción reales. Sus establos reales y ruinas subterráneas son fascinantes.</p>
        `
      },
      en: {
        title: 'The 5 castles you cannot miss in Denmark',
        excerpt: 'From Shakespeare\'s history to the royal residence, Denmark\'s most impressive palaces.',
        content: `
          <p>Denmark is one of the oldest monarchies in the world, which means one thing: Incredible castles! Here are the 5 you must visit:</p>
          
          <h3>1. Rosenborg Castle (Copenhagen)</h3>
          <p>Located in the city center, this Renaissance castle holds the Danish Crown Jewels. Its gardens (Kongens Have) are a favorite spot for locals to picnic.</p>
          
          <h3>2. Amalienborg Palace (Copenhagen)</h3>
          <p>The winter residence of the royal family. It is a complex of four identical palaces around an octagonal square. Don't miss the changing of the guard at noon!</p>
          
          <h3>3. Kronborg Castle (Helsingør)</h3>
          <p>World famous for being the setting of Shakespeare's "Hamlet". Located off the coast of Sweden, it is a UNESCO World Heritage Site.</p>
          
          <h3>4. Frederiksborg Castle (Hillerød)</h3>
          <p>The "Nordic Versailles". It is the largest Renaissance castle in Scandinavia and houses the Museum of National History. Its location on three islets is simply magical.</p>
          
          <h3>5. Christiansborg Palace (Copenhagen)</h3>
          <p>The center of Danish power. It houses the Parliament, the Supreme Court, and the royal reception rooms. Its royal stables and underground ruins are fascinating.</p>
        `
      }
    }
  },
...
// LAST_SEO_UPDATE: 2026-06-21T07:59:45.419Z
